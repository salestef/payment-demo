...
class DashboardConfig 
{
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\SonataAdmin\Dashboard\GroupConfig : static)
     */
    public function group(string $id, array $value = []): \Symfony\Config\SonataAdmin\Dashboard\GroupConfig|static
    {
        if (!\is_array($value)) {
