...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getSonata_Block_Renderer_DefaultService($container)
    {
        ...
        return $container->services['sonata.block.renderer.default'] = new \Sonata\BlockBundle\Block\BlockRenderer($a, $b, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\CallbackController', 'App\\Controller\\InvoiceController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/sonata-project/twig-extensions/src/Bridge/Symfony/Resources/views'), 'SonataTwig');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/sonata-project/twig-extensions/src/Bridge/Symfony/Resources/views'), '!SonataTwig');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/sonata-project/form-extensions/src/Bridge/Symfony/Resources/views'), 'SonataForm');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/sonata-project/form-extensions/src/Bridge/Symfony/Resources/views'), '!SonataForm');
        ...
        $k = ($container->services['knp_menu.matcher'] ?? self::getKnpMenu_MatcherService($container));
        ...
        $instance->addExtension(new \Knp\Menu\Twig\MenuExtension(new \Knp\Menu\Twig\Helper(new \Knp\Menu\Renderer\PsrProvider(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'list' => '?',
            'twig' => '?',
        ]), 'twig', [], false), ($container->privates['knp_menu.menu_provider.chain'] ?? self::getKnpMenu_MenuProvider_ChainService($container)), $j, $k), $k, $j));
