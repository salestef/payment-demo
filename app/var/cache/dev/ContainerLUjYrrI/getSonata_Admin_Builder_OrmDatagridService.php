...
class getSonata_Admin_Builder_OrmDatagridService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sonata.admin.builder.orm_datagrid'] = new \Sonata\DoctrineORMAdminBundle\Builder\DatagridBuilder($a, new \Sonata\AdminBundle\Filter\FilterFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        ])), new \Sonata\AdminBundle\FieldDescription\TypeGuesserChain([new \Sonata\DoctrineORMAdminBundle\FieldDescription\FilterTypeGuesser()]), true);
    }
}
