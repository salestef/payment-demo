 ...
 */
class getSonata_Admin_Orm_Filter_Type_CallbackService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.callback'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\CallbackFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.callback']($container);
    }
}
