 ...
 */
class getSonata_Admin_Orm_Filter_Type_ChoiceService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.choice'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\ChoiceFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.choice']($container);
    }
}
