 ...
 */
class getCreateInvoiceActionService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Service\\Payment\\Invoice\\CreateInvoiceAction'] = new \App\Service\Payment\Invoice\CreateInvoiceAction(($container->privates['App\\Service\\Payment\\SignatureService'] ?? $container->load('getSignatureServiceService')), ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), ($container->privates['App\\Service\\Payment\\Invoice\\Mock\\Response\\SuccessResponseResponseMock'] ??= new \App\Service\Payment\Invoice\Mock\Response\SuccessResponseResponseMock()));
    }
}
