 ...
 */
class getSonata_Admin_Orm_Filter_Type_DateRangeService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.date_range'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\DateRangeFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.date_range']($container);
    }
}
