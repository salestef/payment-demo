 ...
 */
class getSonata_Admin_Orm_Filter_Type_ModelAutocompleteService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.model_autocomplete'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\ModelAutocompleteFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.model_autocomplete']($container);
    }
}
