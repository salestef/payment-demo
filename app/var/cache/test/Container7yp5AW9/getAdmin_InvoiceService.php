 ...
 */
class getAdmin_InvoiceService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'admin.invoice' autowired service.
     *
     * @return \App\Admin\InvoiceAdmin
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Admin/InvoiceAdmin.php';
        ...
        $container->factories['service_container']['admin.invoice'] = function ($container) {
            $instance = new \App\Admin\InvoiceAdmin();
            ...
            $instance->setModelClass('App\\Entity\\Invoice');
            $instance->setBaseControllerName('sonata.admin.controller.crud');
            $instance->setCode('admin.invoice');
            ...
            $instance->setTemplateRegistry(($container->services['admin.invoice.template_registry'] ?? $container->load('getAdmin_Invoice_TemplateRegistryService')));
        ...
        return $container->factories['service_container']['admin.invoice']($container);
    }
}
