 ...
 */
class getSonata_Admin_Orm_Filter_Type_StringService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.string'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\StringFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.string']($container);
    }
}
