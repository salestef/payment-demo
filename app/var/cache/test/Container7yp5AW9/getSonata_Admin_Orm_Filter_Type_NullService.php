 ...
 */
class getSonata_Admin_Orm_Filter_Type_NullService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.null'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\NullFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.null']($container);
    }
}
