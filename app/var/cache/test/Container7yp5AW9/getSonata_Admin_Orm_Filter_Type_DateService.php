 ...
 */
class getSonata_Admin_Orm_Filter_Type_DateService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.date'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\DateFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.date']($container);
    }
}
