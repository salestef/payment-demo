 ...
 */
class getSonata_Admin_Orm_Filter_Type_CountService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.count'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\CountFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.count']($container);
    }
}
