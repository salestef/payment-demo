 ...
 */
class getSonata_Admin_Orm_Filter_Type_NumberService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.number'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\NumberFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.number']($container);
    }
}
