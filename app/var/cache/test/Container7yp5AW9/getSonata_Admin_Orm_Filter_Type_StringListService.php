 ...
 */
class getSonata_Admin_Orm_Filter_Type_StringListService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.string_list'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\StringListFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.string_list']($container);
    }
}
