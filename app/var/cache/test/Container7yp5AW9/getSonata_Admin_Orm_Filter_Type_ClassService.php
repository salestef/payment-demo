 ...
 */
class getSonata_Admin_Orm_Filter_Type_ClassService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.class'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\ClassFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.class']($container);
    }
}
