 ...
 */
class getSonata_Admin_Orm_Filter_Type_DatetimeService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.datetime'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\DateTimeFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.datetime']($container);
    }
}
