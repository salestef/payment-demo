 ...
 */
class getSonata_Admin_Orm_Filter_Type_TimeService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.time'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\TimeFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.time']($container);
    }
}
