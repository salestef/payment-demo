 ...
 */
class getSonata_Admin_Orm_Filter_Type_DatetimeRangeService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.datetime_range'] = function ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\DateTimeRangeFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.datetime_range']($container);
    }
}
